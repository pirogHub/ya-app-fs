...
// import SearchFooter from "../../../components/searchComponents/searchFooter"
...
// import SearchStripe from "../../../components/searchComponents/searchStripe/searchStripe"

import Filters from "./Filters"
// import { useFilters } from "../../../hooks/useFilters/useFilters"
import dataStructService from "../../../services/dataStruct.service"
import Header from "../../../layouts/MainLayout/components/Header"
import ActionsAndStatus from "../../TablePage/components/ActionsAndStatus"
...
const HomeHeader = () => {
    ...
    const { refFiltersState, loadValToFiltersState, syntheticState, getAndSetSyntheticState } = useFilters({ syntheticStateGetter: () => dataStructService.getRandom({ structName: "flat", toWhoom: "seeker" }) })
    ...
    return (
        ...
        >
            ...
            <ActionsAndStatus
                isTransparent={true}
                isShort={true}
                getRandomSeekerAndLoad={getAndSetSyntheticState}
            />
